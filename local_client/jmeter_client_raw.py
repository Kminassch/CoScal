...
for i in range(200, 220):
    k = requests_data[i]
    # os.system("jmeter -n -t C:/Users/sch/PycharmProjects/pythonProject3/data/testjmt.jmx -l f:/jmeter_rawdata/jmeter_rawdata_%s.csv -JthreadNum=%s -JloopNum=1 -JrampupTime=300" % (i, k))
    os.system("jmeter -n -t C:/Users/sch/PycharmProjects/pythonProject3/data/jmeter_client.jmx -l f:/jmeter_rawdata/jmeter_rawdata_%s.csv -JthreadNum=%s -JloopNum=1 -JrampupTime=300" % (i, k))
