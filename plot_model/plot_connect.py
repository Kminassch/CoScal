...
for i in range(200, 300):
    ...
    data = data['Connect']
    data_ad = data_ad['Connect']
    data_k8s = data_k8s['Connect']
    data_hyscal = data_hyscal['Connect']
...
plt.legend()
plt.savefig('plotfig/connect_compare.png')
...
j_rawdata.to_csv('dataset/connect.csv')
j_rawdata_ad.to_csv('dataset/connect_ad.csv')
j_rawdata_k8s.to_csv('dataset/connect_k8s.csv')
j_rawdata_hyscal.to_csv('dataset/connect_hyscal.csv')
