...
hor_save.to_csv('csv/elapsed_hor.csv', header=False)
ver_save.to_csv('csv/elapsed_ver.csv', header=False)
bro_save.to_csv('csv/elapsed_bro.csv', header=False)
...
plt.legend()
plt.savefig('img/elapsed_compare.png')
plt.show()
