...
hor_save.to_csv('csv/connect_hor.csv', header=False)
ver_save.to_csv('csv/connect_ver.csv', header=False)
bro_save.to_csv('csv/connect_bro.csv', header=False)
...
plt.legend()
plt.savefig('img/connect_compare.png')
plt.show()
